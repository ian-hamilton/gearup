            ...
            <tr>
             ...
             <tr>
                ...
                <td style="width: 120px; height: 31px;" align="right">
                    <asp:Label ID="Label4" runat="server" AssociatedControlID="CheckBoxRegistration" Text="Pre-Registration:"></asp:Label>
                </td>
                <td style="height: 31px">
                    <asp:CheckBox ID="CheckBoxRegistration" runat="server" />
                </td>
            </tr>
           <%-- <tr>
             <td style="width: 91px">
                ...
                <td style="width: 120px" align="right">
                    <asp:Label ID="Label9" runat="server" AssociatedControlID="CheckBoxRegistration" Text="facebook Listing:"></asp:Label>
                </td>
                <td>
                    <asp:CheckBox ID="CheckBoxFBRequest" runat="server" Text="Requested"/>
                    <asp:CheckBox ID="CheckBoxApproved" runat="server" Text = "Approved"/>
                </td>
            </tr>--%>
            <tr>
                <td style="width: 91px">
