...
AND SPECIFIC_NAME = 'master_alpha_upload_07B_Oct2006'
)
DROP PROCEDURE ctc.master_alpha_upload_07B_Oct2006
go
---------------------------------------------------------

create procedure ctc.master_alpha_upload_07B_Oct2006
as
...
begin
	...
	from 'c:\ctc_mount_point\07B_Oct2006Mod2.txt'
	with
	(
		fieldterminator = '\t',
		rowterminator='\n',
	...
	values('07B_Oct2006Mod2.txt', getDate(), 'csystem', 'csystem')
