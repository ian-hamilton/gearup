...
AND SPECIFIC_NAME = 'info_attendance_staff'
)
DROP PROCEDURE ctc.info_attendance_staff
go
---------------------------------------------------------

create procedure ctc.info_attendance_staff @id bigint
as
begin
	...
	and event_attendance_name = 'staff'
