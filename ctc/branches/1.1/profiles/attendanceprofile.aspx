<%@ Page Language="C#" MasterPageFile="~/ctc_info.master" AutoEventWireup="true" CodeFile="attendanceprofile.aspx.cs" Inherits="profiles_attendanceprofile" Title="Attendee Profile" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<div>
<p id="page-header">Event Attendee Profile...</p><br />
