<%@ Page Language="C#" MasterPageFile="~/ctc.master" AutoEventWireup="true" CodeFile="addbusinessruleentity.aspx.cs" Inherits="maintenance_addbusinessruleentity" Title="Dreams - Add Entities" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<div>
<p id="page-header">Add Entity...</p><br /><asp:GridView ID="GridViewSelectedEntity" 
    ...
    <table style="width: 483px">
        <tr>
            ...
            <td style="width: 89px; height: 16px" valign="bottom">
                <asp:Label ID="Label2" runat="server" Text="Entity Type"></asp:Label><br />
                <asp:DropDownList ID="DropDownListEntityType" runat="server" Width="131px">
                </asp:DropDownList></td>
            <td valign="bottom">
