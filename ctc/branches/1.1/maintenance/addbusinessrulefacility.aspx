<%@ Page Language="C#" MasterPageFile="~/ctc.master" AutoEventWireup="true" CodeFile="addbusinessrulefacility.aspx.cs" Inherits="maintenance_addbusinessrulefacility" Title="Add Facility" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<div>
<p id="page-header">Add Facility...</p><br /><br />
    <asp:GridView ID="GridViewSelectedFacility" runat="server" AutoGenerateColumns="False"
        CellPadding="4" DataKeyNames="facility_id" ForeColor="#333333" GridLines="None"
        OnSelectedIndexChanged="GridViewSelectedFacility_SelectedIndexChanged" Width="309px">
        ...
        <Columns>
            <asp:CommandField NewText="Remove" SelectText="Remove" ShowSelectButton="True" 
             ...
             <asp:HyperLinkField HeaderText="Facility Name"
