    ...
    <div>
        ...
        <table style="width: 700px" cellspacing="7">
            ...
            <tr>
                <td></td>
                <td>
                    <asp:CheckBox ID="CheckBoxFASFA" runat="server" Text="FASFA Form Submitted" />
                </td>
            </tr>
            <tr>
                <td></td>
                <td>
                    <asp:CheckBox ID="CheckBoxStudentSurvey" runat="server" Text="Student Survey" />
                </td>
            </tr>
            <tr>
                <td></td>
                <td>
                    <asp:CheckBox ID="CheckBoxParentSurvey" runat="server" Text="Parent Survey" />
                </td>
            </tr>
            <tr>
                <td style="width: 284px" align="right">
