...
/// </summary>
public class StudentManager : BusinessEntityManager 
{
    ...
    public System.Collections.Generic.List<Alpha_student_current> selectLikeStudents(string likeString, string userName)
    {
        ...
        returnList = doa.selectObjectsSQL(typeof(Alpha_student_current), DataAccess.SQL_SELECT_ALPHA_PER_SECURITY_UNIT
            .Replace("?1", userName).Replace("?2", likeString));
