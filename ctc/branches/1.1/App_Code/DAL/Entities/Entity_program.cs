...
{
    [ENC_TableName("ctc.entity_program")]
    public class Entity_program : IDataItem
    {

        private System.Int64 _entity_program_id = 0;
        ...
        [ENC_Column("entity_program_id", ENC_ColumnAttribute.keyType.primaryKey, "@@IDENTITY")]
        public System.Int64 entity_program_id
        {
            get { return _entity_program_id; }
            set { _entity_program_id = value; }
        }
