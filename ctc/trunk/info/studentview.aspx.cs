...
public partial class info_studentview : System.Web.UI.Page
{
    ...
    private void loadControls()
    {
        ...
        this.LabelStatusComment.Text = dt.Rows[0]["status_comment"].ToString().Trim();
        ...
        this.LabelEntityComment.Text = dt.Rows[0]["reside_entity_comment"].ToString().Trim();
        ...
        literal = new Literal();
        literal.Text = this.loadTestScoreTable();
    ...
    private String loadThreeEvents()
    {
        ...
        builder.Append("<table class=\"info\" width=\"325\"><tr><th align=\"center\">Date</th><th>Most Recent</th><th>Facilitator</th></tr>");
    ...
    private String loadTopFacilitators()
    {
        ...
        builder.Append("<table class=\"info\" width=\"325\"><tr><th align=\"center\">Top Facilitators</th><th># of Contacts</th><th>Last Contact</th></tr>");
    ...
    private String loadStudentParticipation()
    {
        ...
        builder.Append("<table class=\"info\" width=\"325\"><tr><th align=\"center\">GEAR UP Event History</th><th>Hours</th></tr>");
    ...
    private String loadRParentParticipation()
    {
        ...
        builder.Append("<table class=\"info\" width=\"325\"><tr><th align=\"center\">Residing Entity Events</th><th>Most Recent</th></tr>");
