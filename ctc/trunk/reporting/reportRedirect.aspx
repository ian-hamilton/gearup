...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server" >
    ...
    <div>
       <p id="page-header">
        ...
        <asp:Label ID="LabelReportDesc" runat="server" Text=""></asp:Label></p>
            ...
            <div align="center">
                ...
                <asp:Button ID="ButtonSubmit" runat="server" Text="   Submit   " onclick="ButtonSubmit_Click" OnClientClick="return showAjax();"/>
                    <%--<img id="ajaxGif" alt="" src="../App_Themes/ThemeCTC/images/ajax.gif" 
                        ...
                        <br/><br/>
                <asp:Button ID="ButtonExcel" runat="server" Text="Download an Excel Spreadsheet*"  onclick="ButtonExcel_Click" />
        <br />
        </div>
        <br />
        ...
        **current NCES standards for electronic transmission of individually identifiable student level data excludes the use of email and other forms of electronic transmission except where 256 bit 
        ...
        <br /><br />
       <%-- <div style="width:150;height:100;"> <%--overflow:scroll" >--%>--%>
        <div style="overflow:auto;">

            <asp:GridView ID="GridViewResult" runat="server" CellPadding="4" 
            ForeColor="#333333" GridLines="None" BorderStyle="Inset" 
            BorderWidth="1px" CellSpacing="2" Width="758px" Height="10px" AllowSorting="True" 
            onsorting="GridViewResult_Sorting" EnableSortingAndPagingCallbacks="True" >
