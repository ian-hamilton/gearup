    ...
    <div>
        ...
        <table style="width: 730px; height: 1px" cellspacing="7">
            ...
            <tr>
                ...
                <td style="width: 135px; height: 23px;" align="right">
                    <asp:Label ID="Label2" runat="server" AssociatedControlID="TextBoxBellURL" Text="Bell Schedule URL:"></asp:Label>
                </td>
                <td style="width: 392px; height: 23px;">
                    <asp:TextBox ID="TextBoxBellUrl" runat="server" Width="350px"></asp:TextBox>
                </td>
                <td style="width: 56px; height: 23px;">
                </td>
            </tr>
