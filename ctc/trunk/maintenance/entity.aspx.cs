...
public partial class maintenance_entity : System.Web.UI.Page
{
    ...
    protected void ButtonSearch_Click(object sender, EventArgs e)
    {
        ...
        else if (this.TextBoxEntityId.Text.Length > 0)
        {
            this.GridViewEntity.DataSource = entityManager.selectEntity(Int64.Parse(this.TextBoxEntityId.Text), this.User.Identity.Name);
        }
