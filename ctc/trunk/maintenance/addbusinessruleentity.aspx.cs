...
public partial class maintenance_addbusinessruleentity : System.Web.UI.Page
{
    ...
    private void loadControls()
    {
        ...
        this.DropDownListEntityType.DataSource = entityManager.selectEntitiesByGroup(manager.EntityTypeSearchString);
        ...
        this.DropDownListEntityType.Items.FindByText("Parent").Selected = true;
    ...
    protected void ButtonSearch_Click(object sender, EventArgs e)
    {
        ...
        this.GridViewEntity.DataSource = entityManager.selectLikeEntity(this.TextBoxEntityName.Text, this.DropDownListEntityType.SelectedValue, this.User.Identity.Name);
