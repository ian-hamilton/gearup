...
AND SPECIFIC_NAME = 'facility_upload_high_school'
)
DROP PROCEDURE ctc.facility_upload_high_school
go
---------------------------------------------------------

create procedure ctc.facility_upload_high_school
as
...
begin
	...
	set @ftype_id = (select facility_type_id from ctc.facility_type where facility_type_name = 'High Schools')
	...
	FOR
	select [field1], [field2], [field3], [field4], [field5], [field6], [field7], [field8], [field9], [field10], [field11], [field12], [field13], [field14], [field15], [field16], [field17], [field18], [field19], [field20], [field21], [field22], [field23]
