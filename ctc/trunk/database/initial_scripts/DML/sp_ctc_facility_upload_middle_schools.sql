...
AND SPECIFIC_NAME = 'facility_upload_middle_schools'
)
DROP PROCEDURE ctc.facility_upload_middle_schools
go
---------------------------------------------------------

create procedure ctc.facility_upload_middle_schools
as
...
begin
	...
	from 'c:\ctc_mount_point\Facilities_Middle_Schools.txt'
	with
	(
		fieldterminator = '\t',
		rowterminator='\n',
	...
	set @ftype_id = (select facility_type_id from ctc.facility_type where facility_type_name = 'Middle Schools')
