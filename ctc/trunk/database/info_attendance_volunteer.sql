...
AND SPECIFIC_NAME = 'info_attendance_volunteer'
)
DROP PROCEDURE ctc.info_attendance_volunteer
go
---------------------------------------------------------

create procedure ctc.info_attendance_volunteer @id bigint
as
begin
	...
	and event_attendance_name = 'volunteer'
