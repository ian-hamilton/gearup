...
AND SPECIFIC_NAME = 'info_attendance_family'
)
DROP PROCEDURE ctc.info_attendance_family
go
---------------------------------------------------------

create procedure ctc.info_attendance_family @id bigint
as
begin
	...
	and event_attendance_name = 'family'
