...
AND SPECIFIC_NAME = 'master_alpha_upload_08C_March2008'
)
DROP PROCEDURE ctc.master_alpha_upload_08C_March2008
go
---------------------------------------------------------

create procedure ctc.master_alpha_upload_08C_March2008
as
...
begin
	...
	from 'c:\ctc_mount_point\08C_March2008Mod1.txt'
	with
	(
		fieldterminator = '\t',
		rowterminator='\n',
	...
	values('08C_March2008Mod1.txt', getDate(), 'csystem', 'csystem')
